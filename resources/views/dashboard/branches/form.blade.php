...
<div class="form-group row">
    ...
    <div class="col-sm-10">      
      ...
      value="{{ old('price', isset($branch) ? $branch->price : '') }}">
...
<div class="form-group row">
    ...
    <div class="col-sm-10">      
      ...
      <select class="form-control" name="currency">
        ...
        <option value="egp" {{ isset($branch) && $branch->currency == 'egp' ? 'selected' : ''  }} >EGP</option>
        <option value="uae" {{ isset($branch) && $branch->currency == 'uae' ? 'selected' : ''  }} >UAE</option>
        <option value="dar" {{ isset($branch) && $branch->currency == 'dar' ? 'selected' : ''  }} >DAR</option>
        <option value="usd" {{ isset($branch) && $branch->currency == 'usd' ? 'selected' : ''  }} >USD</option>
      </select>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">      
      ...
      class="form-control {{ $errors->first('description') ? 'is-invalid' : '' }}">
        {{ old('description', isset($branch) ? $branch->description : '') }}
      </textarea>
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
      ...
      class="form-control {{ $errors->first('details') ? 'is-invalid' : '' }}">
        {{ old('details', isset($branch) ? $branch->details : '') }}
      </textarea>
...
<div class="form-group row">
    ...
    @php
      $status = old('status', isset($branch) ? $branch->status : 1);
    @endphp
    <div class="col-sm-10">
...
<div class="form-group row">
    ...
    <div class="col-sm-10" id="select2Parent">      
      ...
      <select class="branchUser form-control w-100 p-2" name="branch_id">
        @foreach($branches as $branch)
        <option value="{{ $branch->id }}" {{ isset($branch) && $branch->branch && $branch->branch->id == $branch->id ? 'selected' : ''  }}>{{ $branch->name }}</option>
        @endforeach
      </select>
